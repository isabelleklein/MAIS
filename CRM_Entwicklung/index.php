...
/*----------------------------*/
/*Errorpage aufrufen*/	
	$pagelist = array(001,002,003,100,101,200,201,202,203,204,205,206,207,208,209,210,250,280,290,300,400,500,501,550,999);
...
/*----------Pages-------------*/
	...
	if($page == 290) include('pages/Vermittler/Vollmacht.php');
